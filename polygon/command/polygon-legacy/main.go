...
import (
	...
	"go.scnd.dev/open/polygon/command/polygon-legacy/common/config"
	"go.scnd.dev/open/polygon/command/polygon-legacy/index"
	"go.scnd.dev/open/polygon/command/polygon-legacy/subcommand/database/sequel"
	"go.scnd.dev/open/polygon/command/polygon-legacy/subcommand/endpoint"
	"go.scnd.dev/open/polygon/command/polygon-legacy/subcommand/inter"
)
