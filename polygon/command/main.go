...
import (
	...
	"go.scnd.dev/polygon/command/common/config"
	"go.scnd.dev/polygon/command/index"
	"go.scnd.dev/polygon/command/subcommand/database/sequel"
	"go.scnd.dev/polygon/command/subcommand/inter"
)
